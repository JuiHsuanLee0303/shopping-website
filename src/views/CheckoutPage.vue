          ...
          <div class="col-md-6">
            <div class="bg-white p-4">
              ...
              <form>
                ...
                <div class="mb-2">
                  <label for="ContactName" class="text-muted mb-0 form-label">Name</label>
                  <input
                    type="text"
                    class="form-control rounded-0"
                    id="ContactName"
            ...
            <div class="bg-white p-4 mt-3">
              <h4 class="fw-bold">2. Shipping Form</h4>
              <form>
                ...
                <div class="form-check mb-2">
                  <input
                    ...
                    checked
                  />
                  <label class="form-check-label text-muted" for="gridRadios1">WebATM </label>
                </div>
                <div class="form-check mb-2">
                  <input
                    class="form-check-input"
                    ...
                    value="option2"
                  />
                  <label class="form-check-label text-muted" for="gridRadios2">ATM </label>
                </div>
                <div class="form-check mb-2">
                  <input
                    class="form-check-input"
                    ...
                    value="option3"
                  />
                  <label class="form-check-label text-muted" for="gridRadios3">ApplePay </label>
                </div>
              </form>
            </div>
            <div
              class="d-flex flex-column-reverse flex-md-row mt-4 justify-content-between align-items-md-center align-items-end fw-100"
            >
